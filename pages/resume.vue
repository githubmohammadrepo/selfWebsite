        ...
        <v-card flat>
          <v-card-text>
            <template>
              ...
              <h5 id="h3" class="pb-1 teal--text">زبانهای برنامه نویسی</h5>
              ...
              <h5 id="h3" class="pb-1 teal--text">تکنولوژی های زبان برنامه نویسی جاوااسکریپت</h5>
              <hr class="pink" />
              <v-row justify="center">
                <v-col
              ...
              <h5 id="h3" class="pb-1 teal--text">تکنولوژی های مربوط به سی اس اس</h5>
              <hr class="pink" />
              <v-row justify="center">
              ...
              <h5 id="h3" class="pb-1 teal--text">تکنولوژی های مربوط به زبان برنامه نویسی پی اچ پی</h5>
              <hr class="pink" />
              <v-row justify="center">
              ...
              <!-- دیتابیس ها -->
              <h5 id="h3" class="pb-1 teal--text">پایگاه داده ها</h5>
              <hr class="pink" />
              <v-row justify="center">
