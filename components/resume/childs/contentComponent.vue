...
import signleCardComponent from '~/components/resume/singleCardComponent'
  export default {
    props:{
      data:{
        type:Array,
    ...
    data:()=>({
      identity:'undefined',
      // this data is here because web have to get data from server when create life cycle hook.
